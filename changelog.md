...
## change log
+ Binance demo integration tests: opt-in spot/USDM demo streams; `.env.example` demo credentials.
+ `binance-usdm-exec`: REST order placement, listen-key helper, strategy egress adapter.
