...
pub use client::{PlaceOrderError, PlaceOrderResult, SpotOrderClient};
pub use egress::{SpotExecEgress, SpotExecEgressError};
...
pub use order::{
    order_from_outbound, OrderBuildError, OrderType, PlaceOrderRequest, Side, TimeInForce,
};
